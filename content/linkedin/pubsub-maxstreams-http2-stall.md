...
So I attached the 'debug' listener. It's documented on the Subscription class, and it appears in none of the samples anyone copies.

230 DEADLINE_EXCEEDED errors in 6 minutes. Across SIX different subscriptions.

Then the arithmetic fell out of it:
...
The part that stayed with me: this is documented. The Subscription class reference says a PubSub instance handles 100 open streams, which works out to "less than 20 Subscriptions per PubSub instance." People have been reporting it since 2018, and the 2023 issue titled "Cannot listen to more than 20 subscriptions?" is still open.
...
Full write-up, with the eight dead ends and the prior art going back to 2018: https://www.hermanyiqunliang.com/blog/pubsub-maxstreams-http2-stall
